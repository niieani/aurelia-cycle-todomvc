...
declare module '~@cycle/rxjs-adapter~@cycle/base/lib/index' {
...
declare module '~@cycle/rxjs-adapter~@cycle/base' {
export * from '~@cycle/rxjs-adapter~@cycle/base/lib/index';
export { default } from '~@cycle/rxjs-adapter~@cycle/base/lib/index';
}

// Generated by typings
// Source: node_modules/@cycle/rxjs-adapter/lib/index.d.ts
declare module '@cycle/rxjs-adapter' {
import { StreamAdapter } from '~@cycle/rxjs-adapter~@cycle/base';
